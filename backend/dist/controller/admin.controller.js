...
import { sendBulkMultiChannelNotification } from "../utils/send-notification.js";
...
export const createNews = asyncHandler(async (req, res) => {
    ...
    if (allRecipients.length > 0) {
        await sendBulkMultiChannelNotification(allRecipients, "New News", "You have a new news", { newsId: news.id });
    }
...
export const deleteNews = asyncHandler(async (req, res) => {
    ...
    if (allRecipients.length > 0) {
        await sendBulkMultiChannelNotification(allRecipients, "News Deleted", "A news item has been deleted", { newsId: news.id });
    }
