  ...
  async function onSubmit() {
    ...
    try {
      ...
      if (response.status === 201) {
        Toast.show({ type: "success", text1: "Requirement posted!" });
        router.push("/(drawer)/tabs/requirements");
      } else {
        Toast.show({ type: "error", text1: "Failed to post requirement" });
      }
    } catch (error) {
        ...
        <View className="p-4">
          ...
          <View className="bg-white p-6 rounded-lg shadow-md">
            ...
            <TouchableOpacity
              ...
              className="bg-blue-600 p-3 rounded-md mt-6 flex-row justify-center items-center"
            >
              {isSubmitting ? (
