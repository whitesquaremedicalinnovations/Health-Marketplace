...
export default function VerificationStatusScreen() {
  ...
  const fetchDoctorData = async (useCache = true) => {
  ...
  const handleRefresh = async () => {
    setRefreshing(true);
    await fetchDoctorData(); // Force fresh data on refresh
    setRefreshing(false);
  };
  ...
  if (!doctorData) {
    return (
      <View style={styles.errorContainer}>
        ...
        <Text style={styles.errorTitle}>Unable to load doctor data</Text>
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.statusCard}>
        ...
        <Text style={styles.statusDescription}>
          {doctorData.isVerified
            ? 'Your doctor profile has been successfully verified. You can now access all features.'
            : 'Your doctor verification is currently under review. This usually takes 1-3 business days.'}
        </Text>
      ...
      <View style={styles.infoCard}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>{doctorData.doctorName}</Text>
        </View>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>{doctorData.phoneNumber}</Text>
        </View>
          ...
          <View style={styles.processStep}>
            ...
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepDescription}>
                Your doctor profile has been submitted for review
              </Text>
            </View>
          </View>
